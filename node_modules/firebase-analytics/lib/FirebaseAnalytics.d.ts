import { FirebaseAnalyticsCodedEvent, FirebaseAnalyticsConfig, FirebaseAnalyticsOptions } from "./FirebaseAnalytics.types";
/**
...
declare class FirebaseAnalytics {
    readonly url: string;
    private enabled;
    readonly config: FirebaseAnalyticsConfig;
    private userId?;
    ...
    private lastTime;
    private sequenceNr;
    constructor(config: FirebaseAnalyticsConfig, options: FirebaseAnalyticsOptions);
    /**
     ...
     */
    static parseEvent(options: FirebaseAnalyticsOptions, eventName: string, eventParams?: {
        [key: string]: any;
    }): FirebaseAnalyticsCodedEvent;
    /**
     ...
     * through the Google Measurement API v2.
     */
    static parseUserProperty(options: FirebaseAnalyticsOptions, userPropertyName: string, userPropertyValue: any): string;
    /**
